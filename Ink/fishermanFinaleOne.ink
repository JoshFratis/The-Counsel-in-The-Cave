...
JASON
Me too. It feels like a relief to have finally decided, even if it’s only to keep asking questions. But… how will <>
{
...
{
    - JasonEntersLayers == true:
        May draws Jason’s gaze from the cloudy depths below

    - else: 
        May follows Jason’s gaze
}
<> and points to the edge of the translucent sky-light. Sitting on the rim, the border between worlds, is a curious figure equipped with a fishing rod. 
...
= three 
We see a silver line fall slowly through the starlight. It drops down the sanctuary to the cloudy depths below. From the mystery of the Layers, the fisherman retrieves…
...
Its matted metal seems strange, industrially welded into such a smooth curve. It reminds May of the transmission towers and powerlines hung above Shiloh Hills. 
It creaks to a stop in front of Jason and May. 
->->

= threeB
~ MoondogFishesGondola = true
The basket seems strange in the absence of a balloon. But it floats into the sanctuary as if it never needed one.
